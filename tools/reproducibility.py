...
def assert_build_postconditions(root,release):
 ...
 expected_pngs={"neutral-board.png","gameplay-context.png","wall-grid-comparison.png","visibility-comparison.png"}|marker_faces|{f"{role}--{variant}.png" for role,variant in ASSETS}
