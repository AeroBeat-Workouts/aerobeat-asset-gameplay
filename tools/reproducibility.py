...
def assert_build_postconditions(root,release):
 ...
 expected_pngs={"neutral-board.png","gameplay-context.png","visibility-comparison.png"}|{f"{role}--{variant}.png" for role,variant in ASSETS}
 ...
 if actual_pngs!=expected_pngs or actual_metadata!={"hashes.v1.json","layout.v1.json","visibility.v1.json"}: raise AssertionError("review inventory")
 return True
