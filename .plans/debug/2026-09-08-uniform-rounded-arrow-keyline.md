...
## Immutable release audit (83dj)

**PASS.** The exact pushed release is commit `6c8f9e09037e880de55af265212533b64e5800ca`, full tree `15b66a5916cc9b3bd441eff1d0063913aa6eb124`, raw `0.0.9` subtree `541b693eabc11c716adca84931015213055ebfe8`, and review `0.0.9` subtree `d491b9b6aa068741ed07d84616d05640482fff60`. Canonical `HEAD`, `main`, and `origin/main` were exact at that release before documentation. The audited build descends from final authority `80378c51b167c329f4c0df4a81510fcd4fe28e6b` / tree `27f0caafa3928476b917631f9e3319f6c0b3aa89`; proof and clean scoped generation inputs independently bind `f2ad27f9c5dd067beca0ab8504565d781e49a9f6` / tree `fe3938e85227d6ea045e8da7330e48cb749c6360`.

Independent filesystem and content recomputation matched raw `17` files / `429,209` bytes / tree digest `979a202bf06d99ebc53588668d67e9d50df7bcd14e9b0d4e69c6dd73b09f9a00`, inventory SHA-256 `95ec22c1657d4931e42327e0544b86f782075288a3330a4d23b0fed07dce65fa`, proof SHA-256 `e1726ca2bc3a0980cc86ba6184bf7da57079f7ee1e42e24094c47196a3dbace9`, review `73` files / `77,797,749` bytes / tree digest `009d21bd09b9015a3f7f9629b96122e3f462875c9a5a3ef87aab578c872b9abc`, and review hashes-manifest SHA-256 `8a7155bbd9a7878eaac37cb1a51eddc21bfb8ab861bf16e65b6d6b0b6b43d282`. The arrow GLB is exactly `152,916` bytes / `75435bc79c0278da5488ab05d1a97ac409cdab390e10483748c30a5aa67ad7e4`. Every raw/review directory and file is finalized at `0555` / `0444`. All 16 predecessor subtrees recomputed exactly: raw `0.0.1`–`0.0.8` are `8e8879a750aa70715fd1ae45e62a447c8e9cd8b6`, `c2dedfd9c18a2260f53b7c013ec77a8dcb10c877`, `aa37bf534cc592a4057127876d567eadc3496f49`, `be36bbd03647bfb4654e0be1ed8b3f6446ced4ec`, `000653eace4b93f3c5d2eef11bd5c8255008b3de`, `53181edfdb560de2aeae01e9a05c212a9b93e438`, `846c41297230b5077ab1119880b729cc120e1098`, and `e26ec4e8278860c60568bd2a89983cd09555ee75`; review `0.0.1`–`0.0.8` are `f0cd9a0a9fdbc7519db5a5f8515d61d479dc22c9`, `b4c68d81faba791ebe7361f9d5a8c1bf339b5e96`, `9122d32d6272854f6fc0f3a29b74997cee799bcf`, `8342d83194d8375886f371d6d57c6fcdda677a6f`, `a1781ce69ba81d660e4ffb24ae8b47d3873c63bb`, `f5652c80852153e746774579e4c1fb495ea360f3`, `8ca78c143d78743ff1dfce1b9fcadc5755a02530`, and `df080ea57c99bb50697f14e891edad7f53dbda2a`.

A fresh local no-hardlink clone was detached at the exact release commit/tree. With canonical `0.0.9` still present, the exact builder command rejected `canonical successor already exists: raw=True review=True; never regenerate` with exit `1`; an instrumented disposable `blender` executable was never resolved or invoked, proving duplicate rejection occurs before Blender and promotion. After making writable and removing only the disposable clone's `release/raw/0.0.9` and `review/0.0.9`, one and only one builder invocation completed with `generation_count=1`. Its complete promoted inventory matched canonical byte-for-byte for every `90` file (`17` raw + `73` review), and staging was absent afterward. The exact clone and invocation marker were then removed; no disposable audit path remains.

Final gates passed against the disposable exact release topology: canonical candidate validation and Blender `4.0.2` source/GLB smoke; the `5,184`-case uniform-arrow pixel oracle; three bulge adversaries and immutable `0.0.8` red-before geometry/raster rejection; all `14` rounded mutations; immutable `0.0.7` validation and smoke; subprocess fatal-signature adversaries; release preflight (`2` wrong versions, `3` existing targets, dirty inputs, predecessor `0.0.8`, altered source/proof anchor, `0` Blender invocations / `0` promotions); and visible-window budget `12` records / `14` instances / `23,688` triangles / `42` draw calls. Arrow/circle/guard are respectively `69 / 64 / 42` samples, `1,928 / 1,788 / 1,172` triangles, Euler `2`, one connected closed geometric two-manifold each, positive signed volumes `0.06330667638182519 / 0.06900413678292198 / 0.07443666445378194`, and minimum explicit-normal dots `0.9999999999962325 / 0.9999999999999819 / 0.9999999999990923`. Material inventories and extras enforce opaque, back-culled, depth-test/write structural bands; only arrow/any `note_fill` is runtime tintable. Arrow bands remained `0.013880242760794824..0.014000077871569134`, `0.05155508756992079..0.052000000000000005`, and `0.019828869049757298..0.020000096786326922`, with raster range `0.01375..0.052177734375`, fill/interior `0.454118017050853 / 0.5693474203797928`, six unchanged GLBs, and exact semantic scene fingerprint `6ec9138f82933e7b94e4732f0b1ea038e85c5e80565ab404ce443c36a249ac11`.

**Disposition:** immutable gameplay asset `0.0.9` is authorized for exact renderer integration and subsequent renderer+assembly consolidated integration audit. This audit does not authorize an immutable web build, web version change, serving change, tag, GitHub Release, npm publication, or physical PASS. Close build Bead `ga90`, then audit Bead `83dj`, and push Dolt state.
